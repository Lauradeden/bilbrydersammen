...
function resetInfo() {
  ...
  efficiency.innerHTML = "<h3>Godt at vide</h3>";
  requirement.innerHTML = "<h3>Bonus tip</h3>";
}
...
function updateInfoboxMobil() {
  ...
  efficiency.innerHTML = "<h3>🔋 Spar på strømmen</h3><p>Skru ned for lysstyrken, luk apps - og glem Tiktok for en stund";
  requirement.innerHTML = "<h3>📞 Nødopkald</h3><p>112 virker uden simkort og netværk. Men ikke hvis du står midt i en tunnel!</p>";
}
...
function updateInfoboxBil() {
  ...
  efficiency.innerHTML = "<h3>⚠️ Bliv synlig</h3><p>Refleksvest på! Du skal ses, ikke stresses.</p>";
  requirement.innerHTML = "<h3>🔧 Tjek motoren?</h3><p>Hvis du ikke ved, hvad du kigger på under motorhjelmen, så lad den blive lukket.</p>";
}
...
function updateInfoboxBagagerum() {
  ...
  efficiency.innerHTML = "<h3>🍫 Snack-strategi</h3><p>Del med omtanke - det er nødproviant, ikke roadtrip-buffet.";
  requirement.innerHTML = "<h3>🧃 Hydration hero</h3><p>Hav altid lidt vand i bagagerummet - kaffe tæller ikke, desværre.";
}
